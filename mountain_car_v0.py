...
env = gym.make('MountainCar-v0') # continuous state space and discrete action space
alpha = 0.1 
gamma = 0.6
epsilon = 0.1 
epi_num = 10000
...
plt.tight_layout()
plt.savefig(result_path+'MountainCar_v0_td_linear_total_reward'+'.png', dpi=100)
plt.show()
...
plt.tight_layout()
plt.savefig(result_path+'MountainCar_v0_td_linear_step_num'+'.png', dpi=100)
plt.show()
...
plt.tight_layout()
plt.savefig(result_path+'MountainCar_v0_td_linear_td_error'+'.png', dpi=100)
plt.show()
